function GetCore()
    ...
    if Config.Framework == "oldesx" then
        ...
        if not object then
            print(
                "x-fuel:Framework is not selected in the config correctly if you're sure it's correct please check your events to get framework object")
        end
    end
    ...
    if Config.Framework == 'autodetect' then
        ...
        if not object then
           ...
           Framework = 'standalone'
            ...
            print("x-fuel:Framework object found : ", Framework)
        end
    end
